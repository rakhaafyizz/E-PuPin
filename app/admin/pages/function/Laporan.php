...
if ($_GET['aksi'] == "tgl_pinjam") {
    ...
    echo "<link rel='icon' type='icon' href='../../../../assets/dist/img/logo.png'>";
    echo "</head>";
    echo "<body onload='window.print()' style='font-family: Quicksand, sans-serif'>";
    echo "<img src='../../../../assets/dist/img/logo.png' style='height: 130px; width: 130px; margin-top: 10px; margin-left: 10px; margin-bottom: -50px;'>";
    echo "<img src='../../../../assets/dist/img/triple.png' style='display: block; margin-left: auto; width: 90px; margin-bottom: -70px; margin-top: -38px; margin-right: 5px;'>";
    ...
    echo "<html>";
    echo "<head>";
    echo "<title>Laporan PerpustakaanF7TUN - Nama Anggota</title>";
    echo "<link rel='stylesheet' href='../../../../assets/dist/css/custom.css'>";
    echo "<link rel='stylesheet' href='../../../../assets/bower_components/bootstrap/dist/css/bootstrap.min.css'>";
    echo "<link rel='stylesheet' href='../../../../assets/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css'>";
    echo "<link rel='icon' type='icon' href='../../../../assets/dist/img/logo.png'>";
